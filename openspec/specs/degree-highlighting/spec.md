# degree-highlighting Specification

## Purpose
Lets a learner highlight a single scale degree's note wherever it
recurs on the fretboard, for any scale family regardless of degree
count, so they can visually track one degree while soloing or
practicing.
